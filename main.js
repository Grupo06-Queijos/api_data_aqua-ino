    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO Registro_Sensor (Umidade, Temperatura, Data_Hora, fkSensor) VALUES (${dht11Umidade}, ${lm35Temperatura}, CURRENT_TIMESTAMP, 1)`;
                ...
                await poolBancoDados.execute(
                    'INSERT INTO Registro_Sensor (Umidade, Temperatura, Data_Hora, fkSensor) VALUES (?, ?, now(), 1)',
